...
class MakeRoomActivity : BaseActivity<ActivityMakeRoomBinding>(R.layout.activity_make_room) {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val selectConfirmMethodFragment = SelectConfirmMethodFragment()
        supportFragmentManager.beginTransaction().add(R.id.container_make_room, selectConfirmMethodFragment )
            .commit()
    }
}